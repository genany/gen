...
export default {
  ...
  changeTypeAction: function(state, action, oldState) {
    ...
    parentDataItem.default = '';
    parentDataItem.ui = { __componentName: 'input' };
      ...
      for (let i in propertiesData) {
        ...
        if (i === name) {
          ...
          newPropertiesData[ranName] = {
            ...utils.defaultSchema.string,
            default: '',
            ui: { __componentName: 'input' }
          };
          console.log('TCL: newPropertiesData', newPropertiesData);
          requiredData.push(ranName);
        }
      }
    }
