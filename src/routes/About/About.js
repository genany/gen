    ...
    return (
        <Card bordered={false}>
          <div class="preview markdown-body">
              <p>您的"star"是我前进的最大动力</p>
              <h2>What?</h2>
              <p>Gen是generator前三个字母。
                  <br/> 根据接口生成页面，减少重复性工作！
              </p>
              ...
              <ol>
                  ...
                  <li>创建页面，
                      <br/> 1)选择页面模版(如： 表单、表格、chart),
                      <br/> 2)选择接口根据字段自动生成配置
                      <br/> 3)选择字段使用组件，选择使用组件扩展字段并配置
                      <br/> 4)如果特殊需求自定义添加组件
                      <br/> 5)点击预览按钮查看页面效果（也可以保存后在查看）
                  </li>
              ...
              <ol>
                  <li>模版和组件扩展配置</li>
                  <li>接口可视化配置</li>
                  <li>使用electon支持本地预览开发</li>
                  <li>自定义脚手架(vue、react、bootstrap、小程序等)</li>
                  <li>可拖拽搭建页面</li>
                  <li>不限语言和框架，通过接口数据生成一切可生成的</li>
              </ol>
              <h2>演示</h2>
              <p><img src="http://gen.sdemo.cn/gen.gif" alt="扩展字段" style={{width: '100%'}}/></p>
          </div>
